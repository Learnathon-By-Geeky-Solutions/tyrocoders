...
import { FaFileAlt, FaFileExcel, FaFileCode, FaDatabase, FaTimes } from "react-icons/fa";
...
const FileItem: React.FC<FileItemProps> = ({ file, progress, onRemove }) => {
  return (
    <li key={file.name} className="bg-gray-50 p-4 rounded-lg shadow-sm flex flex-col">
