          ...
          <form onSubmit={handleSignIn}>
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Button variant="link" type="button" onClick={handleForgotPassword} className="px-0 font-normal text-sm text-[#97d343] hover:text-[#86c232]">
                  Forgot password?
                </Button>
              </div>
            </CardContent>
            <CardFooter>
              <Button type="submit" className="w-full bg-[#97d343] hover:bg-[#86c232] text-[#1a1a1a] font-medium transition-colors" disabled={loading}>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <label htmlFor="terms" className="text-sm font-medium text-gray-300">
                  I agree to the <span className="text-[#97d343] hover:text-[#86c232] cursor-pointer">Terms of Service</span>
                </label>
              </div>
            </CardContent>
            <CardFooter>
