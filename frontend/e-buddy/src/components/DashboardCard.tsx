    ...
    >
      ...
      <CardContent className="p-6">
        <div className="flex items-center gap-4">
          <div className="p-3 rounded-lg bg-gradient-to-br from-accent to-accent/80 text-white">
    ...
    >
      ...
      <CardHeader className="pb-2">
        <div className="flex items-center gap-3">
          <div className="p-2 rounded-lg bg-gradient-to-br from-accent to-accent/80 text-white">
      ...
      <CardContent>
        ...
        <div className="flex justify-end mt-4">
          <span className="text-accent flex items-center gap-1 text-sm font-medium group-hover:text-accent/80 transition-colors">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <FeatureCard
            ...
            link="/billing"
            className="bg-gradient-to-br from-white to-accent/20"
          />
          <FeatureCard
            icon={HelpCircle}
